...
num <- ((x.stratum1[1,1]*x.stratum1[2,2])/total1) + 
       ((x.stratum2[1,1]*x.stratum2[2,2])/total2)
num
den <- ((x.stratum1[1,2]*x.stratum1[2,1])/total1) + 
       ((x.stratum2[1,2]*x.stratum2[2,1])/total2)
den
